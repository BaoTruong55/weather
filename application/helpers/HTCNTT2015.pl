...
n_place(place(binh_duong)) --> [bifnh, duwowng].
n_place(place(dong_nai)) --> [ddoofng, nai].
n_place(place(vung_tau)) --> [vuxng, tafu].
...
n_place(place(da_lat)) --> [ddaf, lajt].
n_place(place(vung_tau)) --> [vuxng, tafu].
n_place(place(hue)) --> [huees].
n_place(place(dong_ha)) --> [ddoong, haf].
n_place(place(ho_chi_minh)) -->[thafnh,phoos,hoof,chis,minh].
n_place(place(ho_chi_minh)) -->[safi, gofn].
